...
class TestSmokeTest():
  def setup_method(self, method):
      options = Options()
      options.headless = True  # Proper way for Firefox
  ...
  def test_homePage(self):
    ...
    self.driver.set_window_size(1500.53, 3151)
  ...
  def test_joinPage(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("Jesus")
    self.driver.find_element(By.NAME, "lname").send_keys("Contreras")
    self.driver.find_element(By.NAME, "bizname").send_keys("printer jesus")
